...
1. Supported: 
Judge only whether the generated answer contains and supports the fact in the current nugget.
The answer should be regarded as supported if it express the same fact as nugget.
It does not need to use the exact same words; semantic equivalent wording is efficient.
...
If the answer supports the nugget in one part but contradicts the nugget in another part, the answer should be regarded as partially supported.
